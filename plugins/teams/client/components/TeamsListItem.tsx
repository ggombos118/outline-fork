...
function TeamsListItem({ integration, collection }: Props) {
  ...
  return (
    <ListItem
      ...
      subtitle={
        <>
          <Trans
            defaults={`Posting to the <em>{{ channelName }}</em> Teams channel on`}
            values={{
            ...
            <PopoverContent side="bottom" align="start">
              <Events>
                ...
                <Text as="p" type="secondary">
                  {t("These events should be posted to Teams")}
                </Text>
                <Switch
      ...
      actions={
        <ConnectedButton
          ...
          confirmationMessage={t(
            "This will prevent any future updates from being posted to this Teams channel. Are you sure?"
          )}
        />
      }
    />
...
export default observer(TeamsListItem);
